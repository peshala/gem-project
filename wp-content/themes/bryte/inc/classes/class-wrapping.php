 ...
 */
add_filter( 'template_include', array( 'Bryte_Wrapping', 'wrap' ), 99 );
add_filter( 'bryte_wrap_base', 'bryte_wrap_base_cpts' );
 ...
 */
function bryte_template_path() {
	return Bryte_Wrapping::$main_template;
}
 ...
 */
function bryte_template_base() {
	return Bryte_Wrapping::$base;
}

if ( ! class_exists( 'Bryte_Wrapping' ) ) {
	...
	class Bryte_Wrapping {
		...
		/**
		 * Initialize new instance of Bryte_Wrapping class by setting a variable for the $slug (which defaults to base)
		...
		public function __toString() {
			$this->templates = apply_filters( 'bryte_wrap_' . $this->slug, $this->templates );
		 ...
		 * and $base as static variables in Bryte_Wrapping class.
		 *
		 * @since 1.0.0
 ...
 */
function bryte_wrap_base_cpts( $templates ) {
