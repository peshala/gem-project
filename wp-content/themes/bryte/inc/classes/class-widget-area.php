...
if ( ! class_exists( 'Bryte_Widget_Area' ) ) {

	/**
	 * Class Bryte_Widget_Area.
	 */
	class Bryte_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'bryte_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'bryte_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'bryte_widget_area_classes', $classes, $area_id );
	 ...
	 * @return object
	 */
	function bryte_widget_area() {
		return Bryte_Widget_Area::get_instance();
	}
