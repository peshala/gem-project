...
if ( ! class_exists( 'Bryte_Playlist_Slider_Widget' ) ) {

	/**
	 * Class Bryte_Playlist_Slider_Widget.
	 */
	class Bryte_Playlist_Slider_Widget extends Cherry_Abstract_Widget {
		...
		public function __construct() {
			$this->widget_name        = esc_html__( 'Playlist Slider', 'bryte' );
			$this->widget_description = esc_html__( 'Display playlist slider on your site.', 'bryte' );
			$this->widget_id          = apply_filters( 'bryte_playlist_slider_widget_ID', 'bryte_widget_playlist_slider' );
			$this->widget_cssclass    = apply_filters( 'bryte_playlist_slider_widget_cssclass', 'widget-playlist-slider' );
			$this->utility            = bryte_utility()->utility;
			$this->settings = array(
				'title' => array(
					'type'  => 'text',
					'value' => esc_html__( 'Playlist Slider', 'bryte' ),
				...
				'posts_per_page' => array(
					...
					'max_value' => 50,
					'min_value' => 0,
					'label'     => esc_html__( 'Posts count ( Set 0 to show all. )', 'bryte' ),
				),
				'width' => array(
					'type'  => 'text',
					'value' => '100%',
					'label' => esc_html__( 'Slider width ( px, %, rem )', 'bryte' ),
				),
				'height' => array(
					'type' => 'text',
					'value' => '500',
					'label' => esc_html__( 'Slider height ( px, rem )', 'bryte' ),
				),
				'thumbnail_controls' => array(
					...
					'value'   => true,
					'options' => array(
						false => esc_html__( 'Hide', 'bryte' ),
						true  => esc_html__( 'Buttons', 'bryte' ),
					),
					'label'       => esc_html__( 'Select Thumbnail Controls', 'bryte' ),
					'placeholder' => esc_html__( 'Select Thumbnail Controls', 'bryte' ),
				),
				'slider_controls' => array(
					...
					'label'       => esc_html__( 'Select Slider Controls', 'bryte' ),
					'placeholder' => esc_html__( 'Select Thumbnail Controls', 'bryte' ),
				),
				'title_length' => array(
					'type'       => 'stepper',
				...
				'thumb_title_length' => array(
					...
					'min_value'  => '0',
					'step_value' => '1',
					'label'      => esc_html__( 'Thumbnail title words length ( Set 0 to hide title. )', 'bryte' ),
				),
				'mate_data' => array(
					'type'  => 'checkbox',
					'value' => array(
					...
					'options' => array(
						'date'     => esc_html__( 'Date', 'bryte' ),
						'author'   => esc_html__( 'Author', 'bryte' ),
						'comments' => esc_html__( 'Comment count', 'bryte' ),
						'category' => esc_html__( 'Category', 'bryte' ),
						'post_tag' => esc_html__( 'Tag', 'bryte' ),
					),
					'label' => esc_html__( 'Display post meta data', 'bryte' ),
				),
				'thumb_mate_data' => array(
					...
					'label' => esc_html__( 'Display thumbnail post meta data', 'bryte' ),
				),
			);
			...
			$this->layout_settings = apply_filters( 'bryte_playlist_slider_size', array(
		...
		public function widget( $args, $instance ) {
			...
			if ( $this->posts ) {
				$slider_settings = array(
					...
					'buttons'            => apply_filters( 'bryte_playlist_buttons', false ),
...
add_action( 'widgets_init', 'bryte_register_playlist_slider_widget' );
/**
 * Register playlist-slider widget.
 */
function bryte_register_playlist_slider_widget() {
	register_widget( 'Bryte_Playlist_Slider_Widget' );
}
