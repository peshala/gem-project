...
<div class="single-modern-header <?php echo esc_html( $invert_class = has_post_thumbnail() ? 'invert' : '' ); ?>">
	...
	<div class="container">
		...
		<header class="entry-header">
			...
			<?php $author_visible = bryte_is_meta_visible( 'single_post_author', 'single' );
		...
		<?php if ( 'post' === get_post_type() ) : ?>
			...
			<div class="entry-meta">
				...
				<?php $date_visible = bryte_is_meta_visible( 'single_post_publish_date', 'single' );
				...
				<?php $comment_visible = bryte_is_meta_visible( 'single_post_comments', 'single' );
				...
				<?php $tags_visible = bryte_is_meta_visible( 'single_post_tags', 'single' );
