	...
	class Cherry_UI_Elements {
		...
		public function ui_elements_require() {
			...
			if ( ! interface_exists( 'I_UI' ) ) {
				require_once get_parent_theme_file_path( 'cherry-framework/modules/cherry-ui-elements/i-ui.php' );
			}

			require_once get_parent_theme_file_path( 'cherry-framework/modules/cherry-ui-elements/ui-element.php' );
			require_once get_parent_theme_file_path( 'cherry-framework/modules/cherry-ui-elements/inc/class-cherry-lock-element.php' );

			if ( ! empty( $this->args['ui_elements'] ) ) {
				foreach ( $this->args['ui_elements'] as $ui_element ) {
					require_once get_parent_theme_file_path( 'cherry-framework/modules/cherry-ui-elements/inc/ui-elements/ui-' . $ui_element . '/ui-' . $ui_element . '.php' );
				}
			}
		}
