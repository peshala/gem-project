...
if ( ! class_exists( 'Cherry_Dynamic_Css' ) ) {
	...
	class Cherry_Dynamic_Css {
		...
		public function init_collector() {
			...
			require_once get_parent_theme_file_path( 'cherry-framework/modules/cherry-dynamic-css/inc/class-cherry-dynamic-css-collector.php' );

			ob_start();
			include get_parent_theme_file_path( 'cherry-framework/modules/cherry-dynamic-css/assets/min/cherry-css-collector.min.js' );
		...
		public function get_css_functions() {
			...
			require_once get_parent_theme_file_path( 'cherry-framework/modules/cherry-dynamic-css/inc/class-cherry-dynamic-css-utilities.php' );
