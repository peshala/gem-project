...
if ( ! class_exists( 'Cherry5_Assets_Loader' ) ) {
	...
	class Cherry5_Assets_Loader {
		...
		public function init() {
			...
			require_once get_parent_theme_file_path( 'cherry-framework/modules/cherry5-assets-loader/inc/cherry5-assets-loader-handle.php' );
			require_once get_parent_theme_file_path( 'cherry-framework/modules/cherry5-assets-loader/inc/cherry5-assets-loader-handle-css.php' );
			require_once get_parent_theme_file_path( 'cherry-framework/modules/cherry5-assets-loader/inc/cherry5-assets-loader-handle-js.php' );
			...
			ob_start();
			include get_parent_theme_file_path( 'cherry-framework/modules/cherry5-assets-loader/assets/min/append.min.js' );
