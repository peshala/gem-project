	...
	class Cherry_Customizer {
		...
		private function include_custom_controls() {
			...
			if ( ! class_exists( 'Cherry_WP_Customize_Iconpicker' ) ) {
				require_once get_parent_theme_file_path( 'cherry-framework/modules/cherry-customizer/inc/class-cherry-wp-customize-iconpicker.php' );
			}
		...
		public function add_panel( $id, $args ) {
			...
			$title           = isset( $args['title'] )           ? esc_attr( $args['title'] ) : esc_html__( 'Untitled Panel', 'bryte' );
		...
		public function add_section( $id, $args ) {
			$prefix          = $this->prefix . '_';
			$title           = isset( $args['title'] )           ? esc_attr( $args['title'] ) : esc_html__( 'Untitled Section', 'bryte' );
			$description     = isset( $args['description'] )     ? esc_attr( $args['description'] ) : '';
		...
		public function add_control( $id, $args ) {
			...
			$title       = isset( $args['title'] )       ? esc_attr( $args['title'] ) : esc_html__( 'Untitled Control', 'bryte' );
			$description = isset( $args['description'] ) ? esc_attr( $args['description'] ) : '';
		...
		public function get_fonts_data() {
			...
			return apply_filters( 'cherry_customizer_get_fonts_data', array(
				'standard' => get_parent_theme_file_path( 'cherry-framework/modules/cherry-customizer/assets/fonts/standard.json' ),
				'google'   => get_parent_theme_file_path( 'cherry-framework/modules/cherry-customizer/assets/fonts/google.json' ),
			), $this );
		}
